...
date: 2026-07-06T12:00:52+07:00
lastmod: 2026-07-08
draft: false
...
{{< github repo="fastfetch-cli/fastfetch" showThumbnail=true >}}
...
![ss1](/fastfetch/ss1.png "`fastfetch`")

### With Template

Kita juga bisa menggunakan template yang sudah disediakan. Biasanya, file konfigurasi template-nya akan tersimpan di `/usr/share/fastfetch/presets` dan `/usr/share/fastfetch/presets/examples`. File configurasi `fastfetch` berekstensi `.jsonc`. Berikut adalah file tree-nya:
...
![ss2](/fastfetch/ss2.png "`fastfetch` with template")
...
![ss3](/fastfetch/ss3.png "`fastfetch` with template 2")
...
![ss4](/fastfetch/ss4.png "`fastfetch` custom output")
