...
date: 2026-07-09T14:33:29+07:00
draft: false
summary: "To be correctly installed so that it can run smoothly on linux (Archlinux to be specific), you need a suitable and straightforward guidance, and this is for you."
...
![ss1](/vmware/ss1.png "CPU virtualization support check")
...
![ss2](/vmware/ss2.png "vmware services status check")
...
![ss3](/vmware/ss3.png "loading kernel module")
...
{{< youtubeLite id="2u2HoIhlZQ0" label="VMWare Installation on Archlinux" >}}
