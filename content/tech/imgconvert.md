...
date: 2026-06-29T11:58:01+07:00
lastmod: 2026-06-30
draft: false
summary: "These are my curated tools (both CLI & GUI) for converting picture file to various formats."
...
{{< github repo="imagemagick/imagemagick" showThumbnail=false >}}
...
![ss1](/imgconvert/ss1.png "converting .HEIC file via `imagemagick`")

### 2. `libheif`

{{< github repo="strukturag/libheif" showThumbnail=false >}}
...
![ss2](/imgconvert/ss2.png "converting .HEIC file via `libheif`")

### 3. `ffmpeg`

{{< github repo="ffmpeg/ffmpeg" showThumbnail=false >}}
...
![ss3](/imgconvert/ss3.png "converting .HEIC file via `ffmpeg`")

### 4. `darktable`

{{< github repo="darktable-org/darktable" showThumbnail=false >}}
...
![ss4](/imgconvert/ss4.png "converting .HEIC file via `darktable`")

### 5. `rawtherapee`

{{< github repo="RawTherapee/RawTherapee" showThumbnail=false >}}
